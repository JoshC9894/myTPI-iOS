...
class JCChecklistReportWP2ViewController: UIViewController {
    ...
    @IBOutlet weak var swl0Label: UILabel!
    @IBOutlet weak var appliedLoad0Label: UILabel!
    @IBOutlet weak var boomLength0Label: UILabel!
    @IBOutlet weak var radius0Label: UILabel!
