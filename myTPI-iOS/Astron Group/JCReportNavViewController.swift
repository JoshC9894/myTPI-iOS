//
//  JCReportNavViewController.swift
//  Astron Group
//
...
class JCReportNavViewController: UIViewController, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let vc1 = JCReport1ViewController(nibName:"JCReport1ViewController", bundle: nil)
        
        self.addChildViewController(vc1)
        self.scrollView.addSubview(vc1.view)
        vc1.didMove(toParentViewController: self)
        
        let vc2 = JCReport2ViewController(nibName:"JCReport2ViewController", bundle: nil)
        ...
        let vc3 = JCChecklistReport(nibName:"JCChecklistReport", bundle: nil)
        ...
        let vc4 = JCChecklist2Report(nibName:"JCChecklist2Report", bundle: nil)
    ...
    @IBAction func createTapped(_ sender: AnyObject) {
        createPDF()
        //Database
        self.object["username"] = PFUser.current()!.username
